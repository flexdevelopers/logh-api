...
angular.module("modules/private/team/view/picks/team.view.picks.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/picks/team.view.picks.tpl.html",
    ...
    "    <a ng-repeat=\"pick in picks | weekPicksFilter:selectedWeek:teamData.league.elimination\" class=\"team-pick list-group-item\" ng-click=\"makePick(teamData, pick)\" ng-class=\"{'locked': !isCoach(teamData) || pick.locked, 'incorrect': pick.correct === false || pick.tie === true}\">\n" +
    "      <div class=\"row\">\n" +
...
},{"./FaqController":81}],3:[function(require,module,exports){
