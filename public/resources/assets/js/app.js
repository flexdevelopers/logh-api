...
angular.module("modules/private/league/edit/league.edit.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/edit/league.edit.tpl.html",
    ...
    "          <span class=\"description\">Survivor format requires a team to make a different pick each week. If incorrect, your team is eliminated. The last team standing wins.</span>\n" +
    "        </div>\n" +
    "        <div class=\"clear\"></div>\n" +
    "      </div>\n" +
    "    </div>\n" +
...
},{"./OffsetFilter":81,"./ActiveTeamFilter":82,"./TimeFilter":83,"./ManagedLeagueFilter":84,"./WeekPicksFilter":85}],2:[function(require,module,exports){
...
},{"./FaqController":87}],6:[function(require,module,exports){
module.exports = angular.module('loghApp.register', [])
  .controller('RegisterController', require('./RegisterController'));

},{"./RegisterController":88}],5:[function(require,module,exports){
...
},{"./SigninController":89}],4:[function(require,module,exports){
module.exports = angular.module('loghApp.abuse', [])
  .controller('AbuseController', require('./AbuseController'));

},{"./AbuseController":90}],8:[function(require,module,exports){
