...
angular.module("common/modules/header/header.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("common/modules/header/header.tpl.html",
    ...
    "                <a class=\"forgot-password btn btn-link pull-right\" role=\"button\" ng-click=\"resetPassword()\">Forgot Password?</a>\n" +
    "              </div>\n" +
...
angular.module("modules/private/league/join/league.join.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/join/league.join.tpl.html",
    ...
    "        <input id=\"teamName\" name=\"teamName\" type=\"text\" class=\"form-control\" placeholder=\"You can change this until the league starts...\" ng-model=\"newTeamData.name\" ng-maxlength=\"25\" required>\n" +
...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "      <button type=\"button\" class=\"coach-only-btn btn btn-default btn-sm dropdown-toggle\">\n" +
    "        <strong>Coach</strong> <span class=\"caret\"></span>\n" +
    "      </button>\n" +
    ...
    "        <li ng-show=\"!leagueData.started && !leagueData.public && !isCommish(leagueData)\"><a ng-click=\"requestInvite(leagueData)\">Request an invite</a></li>\n" +
    ...
    "        <strong>Commish</strong> <span class=\"caret\"></span>\n" +
    "      </button>\n" +
    ...
    "          <div class=\"row\">\n" +
    "            <div class=\"league-name col-sm-6 col-md-6\"><i class=\"fa fa-user fa-fw\" ng-show=\"isCoach(team)\"></i> {{team.name}} <span class=\"coach-name\">{{coachName(team)}}</span></div>\n" +
    "            <div class=\"col-sm-6 col-md-6\">\n" +
...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "    <div class=\"btn-group coach-actions\" ng-show=\"isCoach(teamData)\" dropdown is-open=\"coach.isopen\">\n" +
    "      <button type=\"button\" class=\"coach-btn btn btn-default btn-sm dropdown-toggle\">\n" +
    "        <strong>Coach</strong> <span class=\"caret\"></span>\n" +
    "      </button>\n" +
    "      <ul class=\"dropdown-menu team-coach-menu\" role=\"menu\">\n" +
    "        <li><a ng-click=\"editTeam(teamData)\">Edit team</a></li>\n" +
    "        <li><a ng-click=\"contactCommish(teamData)\">Contact the commish</a></li>\n" +
    "      </ul>\n" +
    "    </div>\n" +
    "    <div class=\"btn-group commish-actions\" ng-show=\"isCommish(teamData)\" dropdown is-open=\"commish.isopen\">\n" +
    "      <button type=\"button\" class=\"commish-btn btn btn-default btn-sm dropdown-toggle\">\n" +
    "        <strong>Commish</strong> <span class=\"caret\"></span>\n" +
    "      </button>\n" +
    "      <ul class=\"dropdown-menu team-commish-menu\" role=\"menu\">\n" +
    "        <li><a ng-click=\"editTeam(teamData)\">Edit team</a></li>\n" +
    "        <li><a ng-click=\"updateMessage(teamData)\">Update team message</a></li>\n" +
    "        <li ng-show=\"!teamData.active\"><a ng-click=\"activate(teamData)\">Reactivate this team</a></li>\n" +
    "        <li ng-show=\"teamData.active\"><a ng-click=\"deactivate(teamData)\">Deactivate this team</a></li>\n" +
    "      </ul>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "</div>\n" +
...
angular.module("modules/public/home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/public/home/home.tpl.html",
    ...
    "        <h1>Pick One Loser.</h1>\n" +
    "        <h1>Each Week.</h1>\n" +
    "        <h1>Simple.</h1>\n" +
    "        <div>\n" +
    "          <a class=\"cta btn btn-success btn-lg\" role=\"button\" ng-click=\"joinLeague(season)\">Join League</a>\n" +
    "        </div>\n" +
    "        <div>\n" +
    "          <a class=\"cta btn btn-success btn-lg\" role=\"button\" ng-click=\"createLeague(season)\">Create League</a>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
...
},{"app-templates":"0VoVTq","./modules/public/home":2,"./modules/public/signin":3,"./modules/public/register":4,"./modules/public/register/terms":5,"./modules/private/user":6,"./modules/private/user/reset":7,"./modules/private/league":8,"./modules/private/league/new":9,"./modules/private/league/view":10,"./modules/private/league/edit":11,"./modules/private/league/contact":12,"./modules/private/league/message":13,"./modules/private/league/join":14,"./modules/private/league/invite":15,"./modules/private/league/invite/request":16,"./modules/private/leagues":17,"./modules/private/leagues/join":18,"./modules/private/leagues/join/public":19,"./modules/private/leagues/join/private":20,"./modules/private/leagues/manage":21,"./modules/private/team":22,"./modules/private/team/view":23,"./modules/private/team/edit":24,"./modules/private/team/message":25,"./modules/private/teams":26,"./modules/private/teams/alive":27,"./modules/private/teams/dead":28,"./modules/private/pick/make":29,"./common/modules/header":30,"./common/modules/message":31,"./common/aspects":32,"./common/models":33,"./common/api":34,"./common/command":35,"./common/service/application":36,"./common/directives/focus":37,"./common/directives/match":38,"./common/directives/requiredPattern":39,"./common/filters":40}],32:[function(require,module,exports){
...
},{"./TestAspect":41}],33:[function(require,module,exports){
/**
...
;
},{"./UserModel":42,"./SeasonModel":43,"./MessageModel":44}],34:[function(require,module,exports){
/**
...
},{"./ApiConfig":45,"./UserService":46,"./LeagueService":47,"./TeamService":48,"./PickService":49,"./SeasonService":50,"./WeekService":51,"./GameService":52}],35:[function(require,module,exports){
// session commands
...
},{"./session/SigninCommand":53,"./session/SignoutCommand":54,"./user/GetCurrentUserCommand":55,"./user/UpdateUserCommand":56}],2:[function(require,module,exports){
...
},{"./HomeController":57}],3:[function(require,module,exports){
...
},{"./SigninController":58}],40:[function(require,module,exports){
/**
...
},{"./OffsetFilter":59,"./ActiveTeamFilter":60,"./OpenLeagueFilter":61,"./TimeFilter":62}],4:[function(require,module,exports){
module.exports = angular.module('loghApp.register', [])
  .controller('RegisterController', require('./RegisterController'));

},{"./RegisterController":63}],6:[function(require,module,exports){
...
},{"./UserController":64}],8:[function(require,module,exports){
...
},{"./LeagueController":65}],17:[function(require,module,exports){
...
},{"./LeaguesController":66}],22:[function(require,module,exports){
...
},{"./TeamController":67}],26:[function(require,module,exports){
...
},{"./JoinLeaguesController":84}],21:[function(require,module,exports){
...
},{"./ManageLeaguesController":85}],23:[function(require,module,exports){
...
},{"./AliveTeamsController":89}],28:[function(require,module,exports){
...
},{"./DeadTeamsController":90}],29:[function(require,module,exports){
module.exports = angular.module('loghApp.pick.make', [])
  .controller('PickMakeController', require('./PickMakeController'));

},{"./PickMakeController":91}],16:[function(require,module,exports){
...
},{"./LeagueInviteRequestController":92}],19:[function(require,module,exports){
...
},{"./PublicLeaguesController":93}],20:[function(require,module,exports){
...
},{"./PrivateLeaguesController":94}],41:[function(require,module,exports){
