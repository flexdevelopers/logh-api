...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "<div class=\"alert alert-danger\" ng-show=\"isCoach(teamData) && teamData.active && teamData.alive && teamData.started && hasNoPick(teamData)\">This team has no pick for the current week. <a class=\"alert-link\" ng-click=\"makePick(teamData)\" ng-disabled=\"!isCoach(teamData)\">Pick a loser</a> before it's too late, buddy.</div>\n" +
