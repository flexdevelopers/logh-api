...
angular.module("common/modules/message/message.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("common/modules/message/message.tpl.html",
    ...
    "  {{messageData.message.content}} <a ng-show=\"messageData.message.share === true\" ng-click=\"share()\" class=\"alert-link\">[ share on facebook ]</a>\n" +
    "</div>\n" +
    "");
}]);
...
},{"./OffsetFilter":84,"./ActiveTeamFilter":85,"./ManagedLeagueFilter":86,"./TimeFilter":87,"./WeekPicksFilter":88}],4:[function(require,module,exports){
