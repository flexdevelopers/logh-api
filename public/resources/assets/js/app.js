...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "            <i class=\"fa fa-minus fa-fw\" ng-show=\"team.current_pick.tie === true\" title=\"Pick tie\"></i>\n" +
    "            <i class=\"fa fa-times fa-fw\" ng-show=\"team.current_pick.correct === false && team.current_pick.tie === false\" title=\"Pick wrong\"></i>\n" +
...
},{"./session/SigninCommand":78,"./session/SignoutCommand":79,"./user/GetCurrentUserCommand":80}],2:[function(require,module,exports){
...
},{"./HomeController":81}],65:[function(require,module,exports){
/**
...
},{"./OffsetFilter":82,"./ActiveTeamFilter":83,"./ManagedLeagueFilter":84,"./TimeFilter":85,"./WeekPicksFilter":86}],3:[function(require,module,exports){
...
var ViewTeamPicksController = function(leagueWeeks, currentWeek, picks, $scope, $log, $location, $stateParams, dateUtils) {
  ...
  $scope.pickStatus = function(pick) {
    ...
    if (pick.correct === true) {
      status = 'check';
    } else if (pick.game && pick.game.tie === true) {
      status = 'minus';
