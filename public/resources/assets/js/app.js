...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "    <a class=\"list-group-item\" ng-class=\"{'inactive': !team.active || !team.alive}\" ng-repeat=\"team in leagueTeams | orderBy:predicate:reverse | activeTeamFilter:teamOptions | filter:search:strict | offsetFilter:(currentTeamPage-1)*teamsPerPage | limitTo:teamsPerPage\" ng-click=\"showTeam(team)\">\n" +
    "      <div class=\"row\">\n" +
...
},{"./OffsetFilter":79,"./ActiveTeamFilter":80,"./AliveTeamFilter":81,"./OpenLeagueFilter":82,"./ManagedLeagueFilter":83,"./TimeFilter":84,"./WeekPicksFilter":85}],5:[function(require,module,exports){
...
},{"./LeaguesController":90}],26:[function(require,module,exports){
...
},{"./MyLeaguesController":119}],25:[function(require,module,exports){
