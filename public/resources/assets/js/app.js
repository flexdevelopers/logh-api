...
angular.module("modules/private/pick/make/pick.make.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/pick/make/pick.make.tpl.html",
    ...
    "        <span ng-class=\"{'invalid-squad': hasSquadBeenUsed(game, squad)}\">{{squad.name}} <span ng-show=\"!game.started && squad.record.length > 0\">[ {{squad.record}} ]</span><span ng-show=\"game.started\">[ {{getScore(game, $index)}} ]</span></span>\n" +
...
},{"./OffsetFilter":68,"./ActiveTeamFilter":69,"./AliveTeamFilter":70,"./OpenLeagueFilter":71,"./ManagedLeagueFilter":72,"./TimeFilter":73}],4:[function(require,module,exports){
