...
angular.module("modules/private/admin/week/admin.week.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/admin/week/admin.week.tpl.html",
    ...
    "        {{game.display}}<br><span class=\"game-starts\">{{dateFormat(game.starts_at, \"ddd, mmm d yyyy h:MM TT (Z)\")}}<span ng-show=\"game.postponed\"> | *PP</span></span></div>\n" +
...
angular.module("modules/private/team/view/picks/team.view.picks.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/picks/team.view.picks.tpl.html",
    ...
    "          <i class=\"fa fa-{{pickStatus(pick)}} fa-fw pick-icon\"></i> <span class=\"pick-squad\"><span class=\"pick-squad-name\">[ {{pick.squad.name}} ]</span><span class=\"pick-squad-abbrev\">[ {{pick.squad.abbrev}} ]</span></span> <span class=\"game-start\">{{pick.week_name}}<span ng-show=\"pick.game.start.length > 0\"> | {{dateFormat(pick.game.start, \"mmm d\")}} | {{dateFormat(pick.game.start, \"h:MM TT Z\")}}</span><span ng-show=\"pick.game.postponed\"> | *PP</span></span>\n" +
    "        </div>\n" +
...
},{"./UserController":90}],5:[function(require,module,exports){
...
},{"./SigninController":91}],10:[function(require,module,exports){
...
},{"./SelectOnClickDirective":109}],9:[function(require,module,exports){
module.exports = angular.module('loghApp.user.reset', [])
  .controller('UserResetController', require('./UserResetController'));

},{"./UserResetController":110}],7:[function(require,module,exports){
