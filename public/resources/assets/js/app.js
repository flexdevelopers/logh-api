...
angular.module("modules/private/team/pick/many/team.pick.many.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/pick/many/team.pick.many.tpl.html",
    ...
    "          <span><span ng-show=\"($index === 1)\">@ </span>{{squad.name}} <span class=\"record-score\" ng-show=\"!game.complete\">[ {{squad.record}} ]</span><span class=\"record-score\" ng-show=\"game.complete\">[ {{getScore(game, $index)}} ] <span ng-show=\"$index === 1\">{{game.ot_display}}</span></span></span>\n" +
