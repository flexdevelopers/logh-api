...
angular.module("modules/private/admin/week/admin.week.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/admin/week/admin.week.tpl.html",
    ...
    "        <span class=\"game-starts\"><span ng-show=\"game.tbd\">TBD</span><span ng-show=\"!game.tbd\">{{dateFormat(game.starts_at, \"ddd, mmm d yyyy h:MM TT (Z)\")}}</span><span ng-show=\"game.if_necessary\"> *If Necessary</span><span ng-show=\"game.postponed\"> | *PP</span></span></div>\n" +
...
},{"./HomeController":81}],5:[function(require,module,exports){
...
},{"./UserController":86}],65:[function(require,module,exports){
/**
...
},{"./OffsetFilter":87,"./ActiveTeamFilter":88,"./ManagedLeagueFilter":89,"./WeekPicksFilter":90,"./TimeFilter":91}],10:[function(require,module,exports){
