...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "      {{leagueData.name}} <small><a ng-show=\"isCommish(leagueData) && !leagueData.started\" ng-click=\"editLeague(leagueData)\">[ Edit ]</a></small> <br>\n" +
    "      <small ng-show=\"leagueData.started\">{{starts(leagueData)}}</small>\n" +
    "      <small ng-show=\"!leagueData.closed && !leagueData.started\">{{starts(leagueData)}} - Join up to {{leagueData.max_teams_per_user}} times</small>\n" +
    ...
    "        <li ng-show=\"hasTeamInLeague()\"><a ng-click=\"joinLeague(leagueData)\">Join again ({{leagueData.max_teams_per_user}} times max)</a></li>\n" +
    "        <li ng-show=\"hasTeamInLeague() && !leagueData.public && !isCommish(leagueData)\"><a ng-click=\"requestInvite(leagueData)\">Request an invite</a></li>\n" +
    "        <li ng-show=\"!isCommish(leagueData)\"><a ng-click=\"contactCommish(leagueData)\">Contact the commish</a></li>\n" +
    "        <li ng-show=\"hasTeamInLeague() && isCommish(leagueData)\" class=\"divider\"></li>\n" +
    ...
    "  </div>\n" +
    "</div>\n" +
    "<div class=\"league-message well well-sm\"><i class=\"fa fa-comment fa-fw\" title=\"Message for the league\"></i> <strong>The commish says:</strong> <em>{{message(leagueData)}}</em> <a ng-show=\"isCommish(leagueData)\" ng-click=\"updateMessage(leagueData)\">[ Update ]</a></div>\n" +
...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "      </ul>\n" +
    "    </div>\n" +
    "    <h3 class=\"team-league-name\"><small><a ng-click=\"showLeague(teamData)\"><i class=\"fa fa-chevron-left fa-fw\"></i> {{teamData.league.name}} league</a></small></h3>\n" +
    "  </div>\n" +
    "  <div class=\"col-sm-4 col-md-4\">\n" +
    ...
    "  </div>\n" +
    "</div>\n" +
    "<div class=\"team-message well well-sm\"><i class=\"fa fa-comment fa-fw\" title=\"Message for this team\"></i> <strong>The commish says:</strong> <em>{{message(teamData)}}</em> <a ng-show=\"isCommish(teamData)\" ng-click=\"updateMessage(teamData)\">[ Update ]</a></div>\n" +
    "<h4>Losers</h4>\n" +
    "<hr>\n" +
...
},{"app-templates":"0VoVTq","./modules/public/home":2,"./modules/public/faq":3,"./modules/public/signin":4,"./modules/public/register":5,"./modules/public/register/terms":6,"./modules/private/user":7,"./modules/private/user/reset":8,"./modules/private/league":9,"./modules/private/league/new":10,"./modules/private/league/view":11,"./modules/private/league/edit":12,"./modules/private/league/contact":13,"./modules/private/league/message":14,"./modules/private/league/join":15,"./modules/private/league/invite":16,"./modules/private/league/invite/request":17,"./modules/private/leagues":18,"./modules/private/leagues/join":19,"./modules/private/leagues/join/public":20,"./modules/private/leagues/join/private":21,"./modules/private/leagues/manage":22,"./modules/private/team":23,"./modules/private/team/view":24,"./modules/private/team/edit":25,"./modules/private/team/message":26,"./modules/private/teams":27,"./modules/private/teams/alive":28,"./modules/private/teams/dead":29,"./modules/private/pick/make":30,"./modules/private/admin":31,"./modules/private/admin/games":32,"./modules/private/admin/games/edit":33,"./common/modules/header":34,"./common/modules/message":35,"./common/modules/footer":36,"./common/aspects":37,"./common/models":38,"./common/api":39,"./common/command":40,"./common/service/application":41,"./common/directives/focus":42,"./common/directives/match":43,"./common/directives/requiredPattern":44,"./common/filters":45}],37:[function(require,module,exports){
...
},{"./TestAspect":46}],38:[function(require,module,exports){
/**
...
;
},{"./UserModel":47,"./SeasonModel":48,"./MessageModel":49}],39:[function(require,module,exports){
/**
...
},{"./ApiConfig":50,"./UserService":51,"./LeagueService":52,"./TeamService":53,"./PickService":54,"./SeasonService":55,"./WeekService":56,"./GameService":57}],40:[function(require,module,exports){
// session commands
...
},{"./session/SigninCommand":58,"./session/SignoutCommand":59,"./user/GetCurrentUserCommand":60}],2:[function(require,module,exports){
...
},{"./HomeController":61}],3:[function(require,module,exports){
module.exports = angular.module('loghApp.faq', [])
  .controller('FaqController', require('./FaqController'));

},{"./FaqController":62}],4:[function(require,module,exports){
...
},{"./SigninController":63}],5:[function(require,module,exports){
module.exports = angular.module('loghApp.register', [])
  .controller('RegisterController', require('./RegisterController'));

},{"./RegisterController":64}],45:[function(require,module,exports){
/**
...
},{"./OffsetFilter":65,"./ActiveTeamFilter":66,"./OpenLeagueFilter":67,"./TimeFilter":68}],7:[function(require,module,exports){
...
},{"./UserController":69}],9:[function(require,module,exports){
...
},{"./LeagueController":70}],18:[function(require,module,exports){
...
},{"./LeaguesController":71}],23:[function(require,module,exports){
...
},{"./TeamController":72}],27:[function(require,module,exports){
...
},{"./TeamsController":73}],31:[function(require,module,exports){
...
},{"./JoinLeaguesController":91}],22:[function(require,module,exports){
...
},{"./ManageLeaguesController":92}],24:[function(require,module,exports){
...
},{"./AliveTeamsController":96}],29:[function(require,module,exports){
...
},{"./DeadTeamsController":97}],30:[function(require,module,exports){
module.exports = angular.module('loghApp.pick.make', [])
  .controller('PickMakeController', require('./PickMakeController'));

},{"./PickMakeController":98}],32:[function(require,module,exports){
...
},{"./AdminGamesController":99}],17:[function(require,module,exports){
...
},{"./LeagueInviteRequestController":100}],20:[function(require,module,exports){
...
},{"./PublicLeaguesController":101}],21:[function(require,module,exports){
...
},{"./PrivateLeaguesController":102}],33:[function(require,module,exports){
module.exports = angular.module('loghApp.admin.games.edit', [])
  .controller('GamesEditController', require('./GamesEditController'));

},{"./GamesEditController":103}],46:[function(require,module,exports){
