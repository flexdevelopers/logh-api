...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "      <accordion-heading>\n" +
    "        <i class=\"fa fa-comment fa-fw\"></i> Commish messages to league [ <span ng-show=\"leagueData.message.length > 0\">1</span><span ng-show=\"!leagueData.message || leagueData.message.length == 0\">0</span> ] <i class=\"pull-right glyphicon\" ng-class=\"{'glyphicon-chevron-down': message.open, 'glyphicon-chevron-right': !message.open}\"></i>\n" +
    "      </accordion-heading>\n" +
    "      <p class=\"league-message-text\" ng-show=\"!leagueData.message || leagueData.message.length == 0\">nothing</p><p class=\"league-message-text\" ng-show=\"leagueData.message.length > 0\" ng-bind-html=\"leagueData.message | linky:'_blank'\"></p> <a class=\"alert-link\" ng-show=\"isCommish(leagueData)\" ng-click=\"updateMessage(leagueData)\">[ edit ]</a><a class=\"alert-link\" ng-show=\"!isCommish(leagueData) && hasTeamInLeague()\" ng-click=\"contactCommish(leagueData)\">[ contact ]</a>\n" +
    "    </accordion-group>\n" +
    "  </accordion>\n" +
    "  <hr>\n" +
    "</div>\n" +
    ...
    "            <i class=\"fa fa-check-circle fa-fw\" ng-show=\"team.current_pick.warning == false\" title=\"All good\"></i>\n" +
...
angular.module("modules/private/team/pick/many/team.pick.many.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/pick/many/team.pick.many.tpl.html",
    ...
    "  <a ng-repeat=\"squad in game.squads\" ng-click=\"togglePick(game, squad)\" class=\"list-group-item\" ng-class=\"{'disabled': isDisabled(game, squad)}\">\n" +
...
angular.module("modules/private/team/view/picks/team.view.picks.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/picks/team.view.picks.tpl.html",
    ...
    "          <i class=\"fa fa-{{pickStatus(pick)}} fa-fw\"></i> <span class=\"pick-squad\"><span class=\"pick-squad-name\">[ {{pick.squad.name}} ]</span><span class=\"pick-squad-abbrev\">[ {{pick.squad.abbrev}} ]</span></span> <span class=\"game-start\">{{pick.week_type}} | {{pick.week_name}}<span ng-show=\"pick.game.start.length > 0\"> | {{pick.game.start}}</span></span>\n" +
    "        </div>\n" +
...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "    <accordion-group is-open=\"message.open\">\n" +
    "      <accordion-heading>\n" +
    "        <i class=\"fa fa-comment fa-fw\"></i> Commish messages to team [ <span ng-show=\"teamData.message.length > 0\">1</span><span ng-show=\"!teamData.message || teamData.message.length == 0\">0</span> ] <i class=\"pull-right glyphicon\" ng-class=\"{'glyphicon-chevron-down': message.open, 'glyphicon-chevron-right': !message.open}\"></i>\n" +
    "      </accordion-heading>\n" +
    "      <p class=\"team-message-text\" ng-show=\"!teamData.message || teamData.message.length == 0\">no message</p><p class=\"team-message-text\" ng-show=\"teamData.message.length > 0\" ng-bind-html=\"teamData.message | linky:'_blank'\"></p> <a class=\"alert-link\" ng-show=\"isCommish(teamData)\" ng-click=\"updateMessage(teamData)\">[ edit ]</a><a class=\"alert-link\" ng-show=\"!isCommish(teamData)\" ng-click=\"contactCommish(teamData)\">[ contact ]</a>\n" +
    "    </accordion-group>\n" +
    "  </accordion>\n" +
    "  <hr>\n" +
    "</div>\n" +
...
},{"./session/SigninCommand":76,"./session/SignoutCommand":77,"./user/GetCurrentUserCommand":78}],63:[function(require,module,exports){
/**
...
},{"./OffsetFilter":79,"./ActiveTeamFilter":80,"./AliveTeamFilter":81,"./ManagedLeagueFilter":82,"./TimeFilter":83,"./WeekPicksFilter":84}],2:[function(require,module,exports){
...
},{"./FaqController":86}],4:[function(require,module,exports){
