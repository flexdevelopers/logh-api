...
angular.module("modules/private/admin/week/admin.week.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/admin/week/admin.week.tpl.html",
    ...
    "  </a>\n" +
    "</div>\n" +
    "<button class=\"btn btn-primary\" ng-click=\"createGame(weekData, games)\">Create Game</button>\n" +
    "");
}]);
...
},{"./session/SigninCommand":71,"./session/SignoutCommand":72,"./user/GetCurrentUserCommand":73}],3:[function(require,module,exports){
module.exports = angular.module('loghApp.faq', [])
  .controller('FaqController', require('./FaqController'));

},{"./FaqController":74}],2:[function(require,module,exports){
...
},{"./HomeController":75}],58:[function(require,module,exports){
/**
...
},{"./OffsetFilter":76,"./ActiveTeamFilter":77,"./AliveTeamFilter":78,"./OpenLeagueFilter":79,"./ManagedLeagueFilter":80,"./TimeFilter":81}],4:[function(require,module,exports){
