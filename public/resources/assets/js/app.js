...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "      <small>{{starts(leagueData)}} - Join up to {{leagueData.max_teams_per_user}} times</small>\n" +
    "    </h3>\n" +
    "  </div>\n" +
    "  <div class=\"col-sm-4 col-md-4\">\n" +
...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "              <i class=\"fa fa-thumbs-down fa-fw\" ng-show=\"pick.correct === false\"></i>\n" +
    "              <i class=\"fa fa-thumbs-up fa-fw\" ng-show=\"pick.correct === true\"></i> [ {{pick.squad_name}} ] <span class=\"game\">{{pick.game_display}}</span>\n" +
    "            </div>\n" +
    "            <div class=\"col-sm-4 col-md-4\">\n" +
...
angular.module("modules/private/teams/alive/teams.alive.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/teams/alive/teams.alive.tpl.html",
    ...
    "        <div class=\"row\">\n" +
    "            <div class=\"team-name col-sm-6 col-md-6\"><i class=\"fa fa-comment fa-fw\" ng-show=\"team.message.length > 0\"></i> {{team.name}} <span class=\"team-league\">{{team.league.name}}</span></div>\n" +
    "            <div class=\"col-sm-6 col-md-6\">\n" +
    "                <span class=\"current-pick\" ng-class=\"{'no-pick': hasNoPick(team)}\" ng-show=\"team.active\">Current Pick: [ {{team.last_pick_squad_name}} ]</span>\n" +
...
angular.module("modules/public/faq/faq.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/public/faq/faq.tpl.html",
    ...
    "    <dd>\n" +
    "      <ul>\n" +
    "        <li>Join a public or private league or create your own league and join it</li>\n" +
    "        <li>Pick ONE loser per week. How easy is that?</li>\n" +
    "        <li>Root for your loser.</li>\n" +
    "        <li>Get it right and move to the next week. Get it wrong and you’re out. Last team standing wins!</li>\n" +
    "      </ul>\n" +
    "    </dd>\n" +
    ...
    "    <dd>As much as the commish allows (with a max of 20 times).</dd>\n" +
    "    <dt>How do I win?</dt>\n" +
...
},{"app-templates":"0VoVTq","./modules/public/home":2,"./modules/public/faq":3,"./modules/public/signin":4,"./modules/public/register":5,"./modules/public/register/terms":6,"./modules/private/user":7,"./modules/private/user/reset":8,"./modules/private/league":9,"./modules/private/league/new":10,"./modules/private/league/view":11,"./modules/private/league/edit":12,"./modules/private/league/contact":13,"./modules/private/league/message":14,"./modules/private/league/join":15,"./modules/private/league/invite":16,"./modules/private/league/invite/request":17,"./modules/private/leagues":18,"./modules/private/leagues/join":19,"./modules/private/leagues/join/public":20,"./modules/private/leagues/join/private":21,"./modules/private/leagues/manage":22,"./modules/private/team":23,"./modules/private/team/view":24,"./modules/private/team/edit":25,"./modules/private/team/message":26,"./modules/private/teams":27,"./modules/private/teams/alive":28,"./modules/private/teams/dead":29,"./modules/private/pick/make":30,"./common/modules/message":31,"./common/modules/header":32,"./common/modules/footer":33,"./common/aspects":34,"./common/models":35,"./common/api":36,"./common/command":37,"./common/service/application":38,"./common/directives/focus":39,"./common/directives/match":40,"./common/directives/requiredPattern":41,"./common/filters":42}],34:[function(require,module,exports){
...
},{"./session/SigninCommand":55,"./session/SignoutCommand":56,"./user/GetCurrentUserCommand":57}],42:[function(require,module,exports){
/**
...
},{"./OffsetFilter":58,"./ActiveTeamFilter":59,"./OpenLeagueFilter":60,"./TimeFilter":61}],2:[function(require,module,exports){
...
},{"./FaqController":63}],4:[function(require,module,exports){
...
},{"./SigninController":64}],5:[function(require,module,exports){
module.exports = angular.module('loghApp.register', [])
  .controller('RegisterController', require('./RegisterController'));

},{"./RegisterController":65}],7:[function(require,module,exports){
...
},{"./UserController":66}],9:[function(require,module,exports){
...
},{"./LeagueController":67}],18:[function(require,module,exports){
...
},{"./LeaguesController":68}],23:[function(require,module,exports){
...
},{"./TeamController":69}],27:[function(require,module,exports){
...
},{"./JoinLeaguesController":87}],22:[function(require,module,exports){
...
},{"./ManageLeaguesController":88}],24:[function(require,module,exports){
...
},{"./AliveTeamsController":92}],29:[function(require,module,exports){
...
},{"./DeadTeamsController":93}],30:[function(require,module,exports){
module.exports = angular.module('loghApp.pick.make', [])
  .controller('PickMakeController', require('./PickMakeController'));

},{"./PickMakeController":94}],17:[function(require,module,exports){
...
},{"./LeagueInviteRequestController":95}],20:[function(require,module,exports){
...
},{"./PublicLeaguesController":96}],21:[function(require,module,exports){
...
},{"./PrivateLeaguesController":97}],43:[function(require,module,exports){
