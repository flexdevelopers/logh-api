...
angular.module("modules/private/league/new/league.new.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/new/league.new.tpl.html",
    ...
    "        <div class=\"form-group\">\n" +
    "          <label class=\"control-label\" for=\"startWeek\">Start week:</label>\n" +
    "          <select id=\"startWeek\" name=\"startWeek\" class=\"form-control\" ng-model=\"newLeagueData.start_week_id\" ng-options=\"week.id as week.display for week in weeks\" required></select>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "    <div class=\"row\">\n" +
    ...
    "<div class=\"modal-footer\">\n" +
    "  <button class=\"btn btn-default\" ng-click=\"cancel()\">Cancel</button>\n" +
    "  <button class=\"btn btn-primary\" ng-disabled=\"newLeagueForm.$invalid || createBtnDisabled\" ng-click=\"createLeague(newLeagueData)\">Create</button>\n" +
    "</div>");
}]);
...
},{"./HomeController":76}],5:[function(require,module,exports){
...
},{"./AbuseController":79}],60:[function(require,module,exports){
/**
...
},{"./OffsetFilter":80,"./ActiveTeamFilter":81,"./AliveTeamFilter":82,"./OpenLeagueFilter":83,"./ManagedLeagueFilter":84,"./TimeFilter":85,"./WeekPicksFilter":86}],6:[function(require,module,exports){
