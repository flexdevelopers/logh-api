...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "  </div>\n" +
    "</div>\n" +
    "<div class=\"league-message well well-sm\" ng-show=\"(!leagueData.start_week_complete || hasTeamInLeague() || isCommish(leagueData)) && leagueData.message.length > 0\"><i class=\"fa fa-comment fa-fw\" title=\"Message for the league\"></i> <strong>The commish says:</strong> <p class=\"league-message-text\" ng-bind-html=\"leagueData.message | linky:'_blank'\"></p> <a ng-show=\"isCommish(leagueData)\" ng-click=\"updateMessage(leagueData)\">[ Update ]</a></div>\n" +
    "<hr>\n" +
...
angular.module("modules/private/pick/make/pick.make.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/pick/make/pick.make.tpl.html",
    ...
    "</div>\n" +
    "<div class=\"modal-body\">\n" +
    "  <div class=\"well well-sm\"><strong>Note:</strong> <em>Teams you have already picked are crossed out.</em></div>\n" +
...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "<div class=\"alert alert-warning\" ng-show=\"teamData.active && !teamData.started\">You cannot make picks until the league starts - {{teamData.start_week_display}}</div>\n" +
    "<div class=\"header-row row\">\n" +
    "  <div class=\"col-sm-8 col-md-8\">\n" +
    ...
    "  </div>\n" +
    "  <div class=\"col-sm-4 col-md-4\">\n" +
    "    <button type=\"button\" class=\"make-pick-btn btn btn-primary btn-sm\" ng-show=\"isCoach(teamData)\" ng-click=\"makePick(teamData)\">Pick Loser</button>\n" +
    ...
    "  </div>\n" +
    "</div>\n" +
    "<div class=\"team-message well well-sm\" ng-show=\"(isCommish(teamData) || isCoach(teamData)) && teamData.message.length > 0\"><i class=\"fa fa-comment fa-fw\" title=\"Message for this team\"></i> <strong>The commish has a message for this team:</strong> <p class=\"team-message-text\" ng-bind-html=\"teamData.message | linky:'_blank'\"></p> <a ng-show=\"isCommish(teamData)\" ng-click=\"updateMessage(teamData)\">[ Update ]</a></div>\n" +
    "<hr>\n" +
    "<h4 class=\"losers-heading\">Loser Picks ({{teamData.pick_count}})</h4>\n" +
...
angular.module("modules/public/faq/faq.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/public/faq/faq.tpl.html",
    ...
    "    <dd>On your league page you’ll find a button. Use it. You’ll need their email address.</dd>\n" +
    ...
    "    <dd>You can’t but you can deactivate (or reactivate) their team. A deactivated team is hidden from view and can’t make any picks so it will have a slow and painful death...</dd>\n" +
...
},{"./HomeController":66}],5:[function(require,module,exports){
...
},{"./OffsetFilter":70,"./ActiveTeamFilter":71,"./AliveTeamFilter":72,"./OpenLeagueFilter":73,"./ManagedLeagueFilter":74,"./TimeFilter":75}],3:[function(require,module,exports){
module.exports = angular.module('loghApp.faq', [])
  .controller('FaqController', require('./FaqController'));

},{"./FaqController":76}],8:[function(require,module,exports){
...
},{"./ViewLeagueController":95}],14:[function(require,module,exports){
...
},{"./MyLeaguesController":102}],27:[function(require,module,exports){
module.exports = angular.module('loghApp.team.edit', [])
  .controller('EditTeamController', require('./EditTeamController'));

},{"./EditTeamController":103}],26:[function(require,module,exports){
...
},{"./ViewTeamController":104}],28:[function(require,module,exports){
