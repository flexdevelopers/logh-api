...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "      <accordion-heading>\n" +
    "        <i class=\"fa fa-comment fa-fw\"></i> Messages to league [ <span ng-show=\"leagueData.message.length > 0\">1</span><span ng-show=\"!leagueData.message || leagueData.message.length == 0\">0</span> ] <i class=\"pull-right glyphicon\" ng-class=\"{'glyphicon-chevron-down': message.open, 'glyphicon-chevron-right': !message.open}\"></i>\n" +
    "      </accordion-heading>\n" +
...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "      <accordion-heading>\n" +
    "        <i class=\"fa fa-comment fa-fw\"></i> Messages to team [ <span ng-show=\"teamData.message.length > 0\">1</span><span ng-show=\"!teamData.message || teamData.message.length == 0\">0</span> ] <i class=\"pull-right glyphicon\" ng-class=\"{'glyphicon-chevron-down': message.open, 'glyphicon-chevron-right': !message.open}\"></i>\n" +
    "      </accordion-heading>\n" +
...
},{"./SigninController":81}],3:[function(require,module,exports){
module.exports = angular.module('loghApp.faq', [])
  .controller('FaqController', require('./FaqController'));

},{"./FaqController":82}],63:[function(require,module,exports){
/**
...
},{"./OffsetFilter":83,"./ActiveTeamFilter":84,"./AliveTeamFilter":85,"./ManagedLeagueFilter":86,"./TimeFilter":87,"./WeekPicksFilter":88}],6:[function(require,module,exports){
...
},{"./LeagueContactController":114}],14:[function(require,module,exports){
module.exports = angular.module('loghApp.league.edit', [])
  .controller('EditLeagueController', require('./EditLeagueController'));

},{"./EditLeagueController":115}],15:[function(require,module,exports){
