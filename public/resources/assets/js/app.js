...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "      </ul>\n" +
    "    </div>\n" +
    "    <h3 class=\"league-meta\">\n" +
    "      <small ng-show=\"leagueData.elimination\">LoseOrGoHome [ single elimination ]</small>\n" +
    "      <small ng-show=\"!leagueData.elimination\">Biggest Loser [ no elimination ]</small><br>\n" +
    ...
    "          <i class=\"fa fa-user fa-fw\" ng-show=\"isCoach(team)\" title=\"My team\"></i><i class=\"fa fa-check fa-fw\" ng-show=\"!isCoach(team) && team.paid == true\" title=\"Paid\"></i> <span class=\"team-name\" ng-class=\"{'inactive': !team.active || !team.alive}\">{{team.name}}</span><br><span class=\"coach-name\">Coach: {{coachName(team)}}</span>\n" +
    "        </div>\n" +
    ...
    "          <span class=\"badge\">Losers [ {{team.correct_picks_count}} ]</span>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </a>\n" +
    "  </div>\n" +
...
angular.module("modules/private/play/teams/play.teams.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/play/teams/play.teams.tpl.html",
    ...
    "          <i class=\"fa fa-check fa-fw\" ng-show=\"team.paid == true && team.message.length == 0\" title=\"Paid\"></i>\n" +
...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "        <i class=\"fa fa-check fa-fw\" ng-show=\"teamData.paid == true\" title=\"Paid\"></i> <strong><span ng-class=\"{'team-inactive': !teamData.active || !teamData.alive}\"><span class=\"team-name\" ng-class=\"{'disabled': !isCoach(teamData) && !isCommish(teamData)}\">{{teamData.name}}</span> <span ng-show=\"isCoach(teamData) || isCommish(teamData)\" class=\"caret\"></span></span></strong>\n" +
    "      </button>\n" +
