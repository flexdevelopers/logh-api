...
angular.module("modules/private/league/edit/league.edit.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/edit/league.edit.tpl.html",
    ...
    "          <input type=\"text\" class=\"form-control\" value=\"Biggest Loser [ most losers ]\" ng-show=\"leagueData.elimination == false\" ng-disabled=\"true\">\n" +
...
angular.module("modules/private/league/new/league.new.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/new/league.new.tpl.html",
    ...
    "        <div class=\"form-group\">\n" +
    "          <div class=\"btn-group league-format-btn-group\">\n" +
    "            <label class=\"btn btn-default league-format-btn\" ng-model=\"newLeagueData.elimination\" btn-radio=\"false\" uncheckable>Biggest Loser<br><span class=\"small-gray\">[ most losers ]</span></label>\n" +
...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    ...
    "      <small ng-show=\"leagueData.elimination\">Survivor [ single elimination ]</small>\n" +
    "      <small ng-show=\"!leagueData.elimination\">Biggest Loser [ most losers ]</small> <br>\n" +
    ...
    "          <span class=\"badge\">{{team.correct_picks_count}} losers</span>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </a>\n" +
    "  </div>\n" +
...
angular.module("modules/private/leagues/join/private/leagues.join.private.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/leagues/join/private/leagues.join.private.tpl.html",
    ...
    "        <div class=\"col-sm-6 col-md-6\">\n" +
    "          <span class=\"start-week\"><span ng-show=\"league.elimination\">Survivor [ single elimination ]</span><span ng-show=\"!league.elimination\">Biggest Loser [ most losers ]</span><br>Starts {{league.start_week}}</span>\n" +
...
angular.module("modules/private/play/leagues/play.leagues.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/play/leagues/play.leagues.tpl.html",
    ...
    "        </div>\n" +
    "        <div class=\"col-sm-6 col-md-6\">\n" +
    "          <span class=\"start-week\"><span ng-show=\"league.elimination\">Survivor [ single elimination ]</span><span ng-show=\"!league.elimination\">Biggest Loser [ most losers ]</span><br>{{starts(league)}}</span>\n" +
...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "        <strong><span ng-class=\"{'team-inactive': !teamData.active || !teamData.alive}\"><span class=\"team-name\" ng-class=\"{'disabled': !isCoach(teamData) && !isCommish(teamData)}\">{{teamData.name}}</span> <span ng-show=\"isCoach(teamData) || isCommish(teamData)\" class=\"caret\"></span></span></strong>\n" +
    "      </button>\n" +
...
},{"./HomeController":67}],50:[function(require,module,exports){
/**
