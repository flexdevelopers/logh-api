...
angular.module("modules/private/team/pick/team.pick.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/pick/team.pick.tpl.html",
    ...
    "      <i class=\"fa fa-check pull-right\" ng-show=\"isPicked(game, squad)\"></i>\n" +
    "    </div>\n" +
    "  </a>\n" +
    "</div>\n" +
    ...
    "<hr>\n" +
    "<div class=\"make-picks-btn-group\">\n" +
    "  <button type=\"button\" class=\"make-pick-btn btn btn-primary\" ng-show=\"isCoach(team) && teamData.league.max_picks_per_week != 1\" ng-click=\"savePick(pick)\" ng-disabled=\"!pick\">Save Picks</button>\n" +
    "</div>\n" +
    "\n" +
    "\n" +
    "");
...
},{"./OffsetFilter":76,"./ActiveTeamFilter":77,"./AliveTeamFilter":78,"./OpenLeagueFilter":79,"./ManagedLeagueFilter":80,"./TimeFilter":81,"./WeekPicksFilter":82}],3:[function(require,module,exports){
module.exports = angular.module('loghApp.faq', [])
  .controller('FaqController', require('./FaqController'));

},{"./FaqController":83}],2:[function(require,module,exports){
...
},{"./MyLeaguesController":119}],27:[function(require,module,exports){
module.exports = angular.module('loghApp.team.edit', [])
  .controller('EditTeamController', require('./EditTeamController'));

},{"./EditTeamController":120}],26:[function(require,module,exports){
