...
angular.module("common/modules/header/header.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("common/modules/header/header.tpl.html",
    ...
    "      <li ng-class=\"{'active': isState(['private.play.teams', 'private.play.leagues'])}\"><a ng-click=\"play(season)\">Play</a></li>\n" +
    ...
    "      <li><a ng-click=\"faq()\"><i class=\"fa fa-question-circle fa-fw\" title=\"FAQ\"></i></a></li>\n" +
    "      <li class=\"dropdown\">\n" +
    ...
    "    </ul>\n" +
    "    <ul ng-show=\"!userData.user.loaded\" class=\"nav navbar-nav navbar-right\">\n" +
    "      <li><a ng-click=\"faq()\"><i class=\"fa fa-question-circle fa-fw\" title=\"FAQ\"></i> FAQ</a></li>\n" +
...
angular.module("modules/private/league/view/league.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/league/view/league.view.tpl.html",
    "<div class=\"alert alert-success\" ng-show=\"leagueData.start_week_complete && aliveTeams.length == 1\"><strong>{{winner(aliveTeams)}}</strong> has earned the prestigious Loser Trophy! Congrats all around...</div>\n" +
    "<div class=\"alert alert-success\" ng-show=\"leagueData.start_week_complete && aliveTeams.length == 0\">Oops. All of the teams are now dead. Check the 'Dead Teams' tab to see how everyone did.</div>\n" +
    ...
    "  </div>\n" +
    "</div>\n" +
    "<div class=\"league-message well well-sm\" ng-show=\"!leagueData.start_week_complete || hasTeamInLeague() || isCommish(leagueData)\"><i class=\"fa fa-comment fa-fw\" title=\"Message for the league\"></i> <strong>The commish says:</strong> <p class=\"league-message-text\" ng-show=\"!leagueData.message || leagueData.message.length == 0\">Nothing</p><p class=\"league-message-text\" ng-show=\"leagueData.message.length > 0\" ng-bind-html=\"leagueData.message | linky:'_blank'\"></p> <a ng-show=\"isCommish(leagueData)\" ng-click=\"updateMessage(leagueData)\">[ Update ]</a><a ng-show=\"!isCommish(leagueData) && hasTeamInLeague()\" ng-click=\"contactCommish(leagueData)\">[ Contact Commish ]</a></div>\n" +
    "<hr>\n" +
    "<h4>Teams ({{leagueData.team_count}}) <small ng-show=\"!leagueData.start_week_complete\"><a ng-click=\"joinLeague(leagueData)\">[ Join up to {{leagueData.max_teams_per_user}} times ]</a></small></h4>\n" +
    "<br>\n" +
    ...
    "      </span>\n" +
    "  </div>\n" +
    "  <div class=\"inactive-teams-checkbox\" ng-class=\"{'not-started': !leagueData.start_week_complete}\" ng-show=\"isCommish(leagueData) && hasDeactivatedTeams()\">\n" +
    "    <a ng-show=\"teamOptions.inactive == true\" ng-click=\"teamOptions.inactive = false\">[ Hide Deactivated<span class=\"teams\"> Teams</span> ]</a>\n" +
    "    <a ng-show=\"teamOptions.inactive == false\" ng-click=\"teamOptions.inactive = true\">[ Show Deactivated<span class=\"teams\"> Teams</span> ]</a>\n" +
    "  </div>\n" +
    "  <tabset>\n" +
    ...
    "              <i class=\"winner-icon fa fa-trophy fa-fw\" ng-show=\"team.active && leagueData.start_week_complete && aliveTeams.length == 1\" title=\"Winner\"></i>\n" +
    "              <i class=\"fa fa-times fa-fw\" title=\"Deactivated Team\" ng-show=\"!team.active\"></i>\n" +
    "              <i class=\"fa fa-user fa-fw\" ng-show=\"team.active && isCoach(team) && !hasWinner(leagueData, aliveTeams)\" title=\"My team\"></i> {{team.name}}<br><span class=\"coach-name\">Coach: {{coachName(team)}}</span></div>\n" +
    "            <div class=\"col-sm-6 col-md-6\">\n" +
...
angular.module("modules/private/play/play.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/play/play.tpl.html",
    ...
    "    </span>\n" +
    "  </div>\n" +
    "  <div class=\"dead-teams-checkbox\" ng-show=\"isState(['private.play.teams'])\">\n" +
    "    <a ng-show=\"teamOptions.dead == true\" ng-click=\"teamOptions.dead = false\">[ Hide Dead Teams ]</a>\n" +
    "    <a ng-show=\"teamOptions.dead == false\" ng-click=\"teamOptions.dead = true\">[ Show Dead Teams ]</a>\n" +
    "  </div>\n" +
    "  <!--<div class=\"managed-leagues-checkbox\" ng-show=\"isState(['private.play.leagues'])\">-->\n" +
    "    <!--<a ng-show=\"leagueOptions.managed == true\" ng-click=\"leagueOptions.managed = false\">[ Hide Managed<span class=\"leagues\"> Leagues</span> ]</a>-->\n" +
    "    <!--<a ng-show=\"leagueOptions.managed == false\" ng-click=\"leagueOptions.managed = true\">[ Show Managed<span class=\"leagues\"> Leagues</span> ]</a>-->\n" +
    "  <!--</div>-->\n" +
    "</div>\n" +
    "\n" +
...
angular.module("modules/private/play/teams/play.teams.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/play/teams/play.teams.tpl.html",
    ...
    "          <i class=\"fa fa-times fa-fw\" title=\"Deactivated Team\" ng-show=\"!team.active\"></i>\n" +
    "          <i class=\"fa fa-thumbs-down fa-fw\" title=\"Dead Team\" ng-show=\"team.active && !team.alive\"></i> <span ng-class=\"{'inactive-team-name': !team.active}\">{{team.name}}</span><br><span class=\"team-league\">{{team.league.name}}</span></div>\n" +
    "        <div class=\"col-sm-6 col-md-6\">\n" +
    "          <span class=\"current-pick\" ng-class=\"{'no-pick': hasNoPick(team)}\" ng-show=\"team.active\">Current Loser: {{team.last_pick_squad_name}}</span>\n" +
...
angular.module("modules/private/team/view/team.view.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/team/view/team.view.tpl.html",
    ...
    "  </div>\n" +
    "</div>\n" +
    "<div class=\"team-message well well-sm\" ng-show=\"isCommish(teamData) || isCoach(teamData)\"><i class=\"fa fa-comment fa-fw\" title=\"Message for this team\"></i> <strong>The commish says:</strong> <p class=\"team-message-text\" ng-show=\"!teamData.message || teamData.message.length == 0\">Nothing</p><p class=\"team-message-text\" ng-show=\"teamData.message.length > 0\" ng-bind-html=\"teamData.message | linky:'_blank'\"></p> <a ng-show=\"isCommish(teamData)\" ng-click=\"updateMessage(teamData)\">[ Update ]</a><a ng-show=\"!isCommish(teamData)\" ng-click=\"contactCommish(teamData)\">[ Contact Commish ]</a></div>\n" +
    "<hr>\n" +
    ...
    "            <i class=\"fa fa-thumbs-up fa-fw\" ng-show=\"pick.correct === true\" title=\"Pick correct\"></i> <span class=\"pick-squad\" ng-class=\"{'pick-correct': pick.correct === true, 'pick-incorrect': pick.correct === false}\">[ {{pick.squad_name}} ]</span> <span class=\"game\">Week {{pick.week_number}} ({{pick.week_type}})</span>\n" +
    "          </div>\n" +
    "          <div class=\"col-sm-6 col-md-6\">\n" +
...
angular.module("modules/public/home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/public/home/home.tpl.html",
    ...
    "    <h1 class=\"header-jumbo\">Losers Wanted</h1>\n" +
    "    <p class=\"lead\">Pick one loser a week. Simple.</p>\n" +
    "  <div>\n" +
...
},{"./session/SigninCommand":63,"./session/SignoutCommand":64,"./user/GetCurrentUserCommand":65}],50:[function(require,module,exports){
/**
...
},{"./OffsetFilter":66,"./ActiveTeamFilter":67,"./AliveTeamFilter":68,"./OpenLeagueFilter":69,"./ManagedLeagueFilter":70,"./TimeFilter":71}],2:[function(require,module,exports){
...
},{"./HomeController":72}],3:[function(require,module,exports){
...
},{"./TeamController":80}],28:[function(require,module,exports){
...
},{"./EditTeamController":104}],29:[function(require,module,exports){
      ...
      var promise = $http.post(
            ...
            .success(function(data) {
                ...
                if (redirect !== 'undefined') {
                  ...
                  $location.path('/season/' + seasonModel.season.id + '/my/leagues');
                }
                return data;
            })
            .error(function(data) {
...
//@ sourceMappingURL=data:application/json;base64,
;