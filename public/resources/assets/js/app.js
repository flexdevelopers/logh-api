...
angular.module("modules/private/leagues/join/private/leagues.join.private.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/private/leagues/join/private/leagues.join.private.tpl.html",
    ...
    "        <div class=\"row\">\n" +
    "            <div class=\"league-name col-sm-6 col-md-6\" ng-class=\"{'closed': !league.open}\"><i class=\"fa fa-times fa-fw\" title=\"Closed league\" ng-show=\"!league.open\"></i> {{league.name}} <span class=\"team-count\">Join up to {{league.max_teams_per_user}} times<br>Commish: {{league.commish_names[0]}}</span></div>\n" +
    "            <div class=\"col-sm-6 col-md-6\">\n" +
